---
layout:     post
title:      "Alat Pakan Ternak Ayam Otomatis"
# subtitle:   "用户访问认证与鉴权"
description: "Broiler adalah istilah yang biasa dipakai untuk menyebut ayam hasil budidaya teknologi peternakan yang memiliki karakteristik ekonomi dengan ciri khas pertumbuhan yang cepat, sebagai penghasil daging dengan konversi pakan rendah dan siap dipotong pada usia yang relatif muda. Pada umumnya broiler ini siap panen pada usia 28-45 hari dengan berat badan 1,2- 1,9 kg/ekor. Ayam broiler merupakan hasil persilangan antara bangsa ayam cornish dari Inggris dengan ayam white play mounth rock dari Amerika."
date:       2022-09-16
...
# Alat Pakan Ternak Ayam Otomatis
![screenshot](/img/pakan-otomatis.jpeg)
Broiler adalah istilah yang biasa dipakai untuk menyebut ayam hasil budidaya teknologi peternakan yang memiliki karakteristik ekonomi dengan ciri khas pertumbuhan yang cepat, sebagai penghasil daging dengan konversi pakan rendah dan siap dipotong pada usia yang relatif muda. Pada umumnya broiler ini siap panen pada usia 28-45 hari dengan berat badan 1,2- 1,9 kg/ekor. Ayam broiler merupakan hasil persilangan antara bangsa ayam cornish dari Inggris dengan ayam white play mounth rock dari Amerika.

Alat Pemberi Pakan dan Minum Ternak Ayam Otomatis Dengan Menggunakan Aplikasi Android ini dirancang agar memudahkan peternak lokal dalam memelihara ternak ayam, sehingga pemberian pakan ayam dapat dilakukan dengan tepat waktu dan juga dapat mengoptimalkan jumlah pekerja. Alat ini dapat menyalurkan pakan ayam sebanyak dua kali dalam sehari dengan menggunakan RTC (Real Time Clock). RTC berguna untuk mengatur jadwal pemberian pakan ayam. Alat ini menggunakan motor power window sebagai penggerak wadah pakan dan motor Stepper sebagai penyalur pakan ayam. Alat ini dilengkapi dengan sensor ultrasonik, dimana sensor ini berfungsi untuk mengetahui kondisi pakan ayam dalam wadah penampung,. Jika pakan ayam dalam wadah penampung sudah habis maka pesan akan masuk ke android yang menandakan pakan ayam sudah habis dalam wadah.
![screenshot](/img/modul-esp.png)
Alat ini menggunakan modul esp8266 dimana modul ini berfungsi untuk menghubungkan koneksi android dengan Arduino uno,
![screenshot](/img/uno.png)

koneksi android berguna untuk monitoring stok pakan ayam di dalam wadah penampung, ketika pakan dalam wadah telah habis, maka notifikasi akan masuk ke android sebagai pemberitahuan bagi peternak. Kapasitas maksimum pada wadah penampung pakan ayam adalah 20 kg dan dalam sekali proses pemberian pakan ayam, alat ini dapat menyalurkan sebanyak 880 gr pakan ayam dan membutuhkan waktu selama 2 menit 28 detik untuk menyalurkan pakan.

Bagi peternak yang memiliki sejumlah besar ayam, dapat menjadi tugas yang sulit untuk menjaga mereka memberi makan sepanjang waktu.Apalagi jika peternak tersebut juga berprofesi sebagai petani. Umumnya para peternak memberikan pakan menggunakan tangan dan harus berjalan sepanjang kandang yang mana kandang ayam yang diternakkan dalam jumlah besar biasanya jauh dari pemukiman. Kegiatan seperti itu bagi peternak ayam akan menyita waktu dan tenaga. Alat ini akan membuat peternak menggunakan waktunya sebaik mungkin. Pemberian pakan ayam dapat dipermudah dengan penggunaan alat mekanik yang dikontrol oleh peralatan eletronik. Sistem ini merupakan alat kontrol yang mampu memberikan pakan ayam secara otomatis sesuai jadwal. Pengendali utama sistem ini menggunakan mikrokontroler yang di program dan di delay sebagai penyesuaian waktu pemberian pakan ayam. Metode yang digunakan ini memiliki keunggulan pengembang dapat bekerja lebih baik dalam menentukan kebutuhan setiap pelanggannya dan lebih menghemat waktu dalam pengembangan sistem.
